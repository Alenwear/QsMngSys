...
--
-- Host: localhost
-- Generation Time: 2018-06-29 02:12:41
-- 服务器版本： 5.7.21
-- PHP Version: 5.6.33
...
INSERT INTO `UserList` (`id`, `Name`, `Department`, `UserName`, `Pwd`, `Role`) VALUES
(1, '李光耀', '质检科', 'lgy', 'c4ca4238a0b923820dcc509a6f75849b', '质量审核员'),
(2, '史相陆', '质检科', 'sxl', '202cb962ac59075b964b07152d234b70', '质检科领导');
...
CREATE TABLE `UserRoles` (
  `id` int(11) NOT NULL,
  `RoleName` varchar(20) COLLATE utf8_bin NOT NULL COMMENT '角色名'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
