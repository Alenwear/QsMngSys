...
<div id="myTabContent" class="tab-content">
    <div class="tab-pane fade in active" id="home">
        <div class="container-fluid">
            <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" action="<?php echo U('Airlines/AirlineMdf');?>">
                <div class="alert alert-info" role="alert" style="margin-top: 10px;"><div class="col-sm-offset-0"><strong>提示：</strong>航空公司的添加与删除，要想删除某一航空公司，必须先删除该公司的所有航班。</div></div>
                ...
                <div style="margin-top: 10px">
                    ...
                    <div class="form-group">
                        <label for="Name" class="col-sm-2 control-label">航空公司:</label>
                        <div class="col-sm-3">
                            <input class="form-control" type="text" id="Name" name="Name"  placeholder="请写公司全称" />
                        </div>
                        <div class="col-sm-1" style="width: 100px;">
                            <label for="Code" class="control-label">二字代码:</label>
                        </div>
                        <div class="col-sm-2">
                            <input type="text" id = "Code" type="text"  class="form-control"  name="Code" placeholder="二字代码" />
                        </div>
                        <button type="submit" class="btn btn-primary">添加</button>
                    </div>

                    <h4 style="margin-top: 30px;text-align: center">当前数据库中所有航空公司</h4>
                    <hr/>
                    <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                        ...
                        <tbody>
                        <?php if(is_array($Airlines)): $i = 0; $__LIST__ = $Airlines;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <td>
                                    <?php echo ($vo["id"]); ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    <span class="badge"><?php echo ($vo["FlightCount"]); ?></span>
                                </td>
                                <td>
...
<script>
    $(function () {
        ...
        $("a[BtnID]").click(function () {
            window.location = "<?php echo U('Airlines/DelAirline');?>"+"&id="+$(this).attr("BtnID");
        })
    });
</script>
</html>
