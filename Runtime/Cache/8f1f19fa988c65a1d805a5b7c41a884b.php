...
<head>
    <meta charset="UTF-8">
    <title>洛阳机场航班运行数据分析管理系统</title>
    <script>

    </script>
    <!-- The styles -->
    <link id="bs-css" href="__PUBLIC__/css/bootstrap-cerulean.min.css" rel="stylesheet">
    <link href='__PUBLIC__/bower_components/responsive-tables/responsive-tables.css' rel='stylesheet'>    <!-- jQuery -->
    ...
    <div class="row">
        ...
        <div class="row">
            <div class="well col-md-5 center login-box">
                ...
                <form class="form-horizontal" action="<?php echo U('Login/Login');?>" enctype="multipart/form-data" method="post">
                    <fieldset>
