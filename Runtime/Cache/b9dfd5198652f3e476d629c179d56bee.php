                    ...
                    <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                        ...
                        <?php if(is_array($Flightlist)): $i = 0; $__LIST__ = $Flightlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                    ...
                                    <?php if(($vo["Category"]) == "1"): ?><span style="color: blue;font-weight: bold">国际</span><?php endif; ?>
                                    <?php if(($vo["Category"]) == "2"): ?><span style="color: green;font-weight: bold">国际</span>地区<?php endif; ?>
                                </td>
                                <td>
